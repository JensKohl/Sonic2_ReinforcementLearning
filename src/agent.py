"""
Agent Core Module providing Actor-Critic architecture setup.
"""
import torch
...
class Agent(nn.Module):
    ...
    def __init__(self, envs):
        ...
        self.critic = nn.Sequential(layer_init(nn.Linear(512, 1), std=1.0))
    ...
    def get_value(self, x):
        """
        Used during the 'Advantage' calculation to see how much better
        a state was than expected.
        """
